...
static int app_tuya_auto_recovery_factory_reset_timer_handler(ke_msg_id_t const msgid,
        void *param,
        ke_task_id_t const dest_id,
        ke_task_id_t const src_id)
{
...
static int app_tuya_auto_recovery_from_resetting_timer_handler(ke_msg_id_t const msgid,
        void *param,
        ke_task_id_t const dest_id,
        ke_task_id_t const src_id)
{
    ...
    event.hdr.event = TUYA_BLE_EVT_AUTO_RECOVERY_FROM_RESETTING_TIMEOUT;

    if(tuya_ble_event_send(&event)!=0)
    {
        TUYA_BLE_LOG_ERROR("TUYA_BLE_EVT_AUTO_RECOVERY_FROM_RESETTING_TIMEOUT event send failed.");
    }
...
#if TUYA_BLE_AUTO_RECOVERY_FROM_RESETTING_ENABLE
    {APP_TUYA_AUTO_RECOVERY_FACTORY_RESET_TIMER ,   (ke_msg_func_t)app_tuya_auto_recovery_factory_reset_timer_handler},
