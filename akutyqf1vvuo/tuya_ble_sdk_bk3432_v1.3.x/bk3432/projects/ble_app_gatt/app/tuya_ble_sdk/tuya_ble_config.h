...
/*
 * if defined ,include Automatic recovery after resetting by mistake module
 */
#ifndef TUYA_BLE_AUTO_RECOVERY_FROM_RESETTING_ENABLE
#define TUYA_BLE_AUTO_RECOVERY_FROM_RESETTING_ENABLE 1
#endif

#if TUYA_BLE_AUTO_RECOVERY_FROM_RESETTING_ENABLE

#ifndef TUYA_BLE_AUTO_RECOVERY_FACTORY_RESET_TIME_MS
#define TUYA_BLE_AUTO_RECOVERY_FACTORY_RESET_TIME_MS  100 //*10ms
#endif

#ifndef TUYA_BLE_AUTO_RECOVERY_FROM_RESETTING_TIME_MS
#define TUYA_BLE_AUTO_RECOVERY_FROM_RESETTING_TIME_MS 60000  //600s(60000*10ms)
#endif
