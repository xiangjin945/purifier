...
#define TUYA_BLE_LOG_INFO(fmt,args...)     
...
#define TUYA_APP_LOG_ERROR(...)                          UART_PRINTF(__VA_ARGS__)
#define TUYA_APP_LOG_WARNING(...)                        UART_PRINTF(__VA_ARGS__)
#define TUYA_APP_LOG_INFO(...)                           UART_PRINTF(__VA_ARGS__)
#define TUYA_APP_LOG_DEBUG(...)                          UART_PRINTF(__VA_ARGS__)
