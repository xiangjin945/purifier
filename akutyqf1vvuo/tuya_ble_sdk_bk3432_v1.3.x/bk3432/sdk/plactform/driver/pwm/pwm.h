...
#define ICU_PWM_CLK_PWM_X_SEL_32KHZ(x)      do {REG_AHB0_ICU_PWMCLKCON &= (~ICU_PWM_CLK_PWM_X_SEL_MASK(0));} while (0)
#define ICU_PWM_CLK_PWM_X_SEL_16MHZ(x)      do {REG_AHB0_ICU_PWMCLKCON |= ( ICU_PWM_CLK_PWM_X_SEL_MASK(0));} while (0)
